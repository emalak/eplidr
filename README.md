...
Table2, err =eplidr.NewSingleKeyTable("tableName2",
		...
		eplidr.TableFields{
			...
			eplidr.DefaultTableField{Name: "description", Type: eplidr.GetSizedType(eplidr.BasicTypeVarChar, 400)},
			...
			eplidr.DefaultTableField{Name: "photo", Type: eplidr.TypeUUID},
			eplidr.DefaultTableField{Name: "creator", Type: eplidr.TypeUUID},
			eplidr.DefaultTableField{Name: "location", Type: eplidr.TypeUUID},
			eplidr.DefaultTableField{Name: "address", Type: eplidr.GetSizedType(eplidr.BasicTypeVarChar, 300)},
